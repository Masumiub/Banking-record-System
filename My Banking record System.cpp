...
void account_query:: search_rec()
{
  ...
  cout<< "Enter Record Number to Search:"<< endl;
  cin>> n;
...
void account_query:: edit_rec(){
  ...
  cin>> n;
    ...
    show_data();
    iofile.close();
    iofile.open("record.bank", ios::out | ios:: out|ios::in|ios::binary);
    iofile.seekp((n-1)*sizeof(*this));
    cout<< "Enter data to edit"<< endl;
    read_data();
...
void account_query::delete_rec() {
    ...
    infile.seekg(0, ios::end);
    int count= infile.tellg()/sizeof(*this);
    cout<< "There are"<< count<< "record in this file"<< endl;
...
int main(){
  account_query A;
  int choice;
  cout<< "***Welcome to My first C Project***"<< endl;
  cout<< "***Account Information System***"<< endl;
  while (true) {
    cout<< "Select One Option Below"<< endl;
    cout<< "1. Add Record to file:"<< endl;
    cout<< "2. Show Record to file:"<< endl;
